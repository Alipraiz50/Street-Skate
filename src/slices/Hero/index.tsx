...
const Hero = ({ slice }: HeroProps): JSX.Element => {
  ...
  return (
    <Bounded
      ...
      className="bg-brand-blue relative h-dvh overflow-hidden text-zinc-800 bg-texture"
    >
      <div className="absolute inset-0 flex items-center pt-20">
        <WideLogo className="w-full text-brand-black hidden opacity-20 mix-blend-multiply lg:block" />
        <TallLogo className="w-full text-brand-black opacity-20 mix-blend-multiply lg:hidden" />
      </div>
